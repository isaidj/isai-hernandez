...
export const SkeletonDashboard = () => {
  return (
    <Card className="w-[400px] h-[500px] space-y-5 p-4 bg-zinc-900" radius="lg">
      <Skeleton className="rounded-lg bg-zinc-600 h-3/4">
        <div className="h-24 rounded-lg bg-"></div>
      </Skeleton>
      <div className="space-y-3">
        <Skeleton className="w-3/5 h-2/5 rounded-lg bg-zinc-600">
